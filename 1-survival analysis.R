...
data <- read.csv(file="/Users/Desktop/vgh/excel/cervical_cancer_data.csv")
...
###################################################
### Preliminary Variable Selection (covariates) ###
###################################################
...
################################################################
### find cutpoints of biomarkers and stepwise cox regression ###
################################################################
